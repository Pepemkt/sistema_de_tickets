  ...
  return (
    <section className="relative grid min-h-screen place-items-center overflow-hidden px-4">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-24 top-16 h-72 w-72 animate-pulse rounded-full bg-coral-300/25 blur-3xl" />
        <div className="absolute right-0 top-1/3 h-80 w-80 animate-pulse rounded-full bg-forest-400/20 blur-3xl [animation-delay:400ms]" />
      </div>

      <div className="panel relative z-10 w-full max-w-md p-8">
        <p className="text-sm font-semibold uppercase tracking-wide text-[color:var(--brand-magenta)]">Aiderbrand</p>
